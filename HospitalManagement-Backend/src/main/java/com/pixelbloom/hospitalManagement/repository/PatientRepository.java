...
import com.pixelbloom.hospitalManagement.dto.BloodGroupCountResponseEntity;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select new com.pixelbloom.hospitalManagement.dto.BloodGroupCountResponseEntity(p.bloodGroup," +
